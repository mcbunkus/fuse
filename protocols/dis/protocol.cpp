...
fuse::Result<int> DisProtocol::Send(const fuse::IMessage &msg)
{
    ...
    // }
    //
    // // TODO: this might be confusing working with strings here, when in
    // reality
    // // we're just working with raw bytes. Maybe make a class that makes it
    // more
...
fuse::Result<>
DisProtocol::configure(const fuse::configuration::IConfiguration &config)
{
